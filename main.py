...
banned_words = ["nigga", "nigg4", "fuck", "stfu", "kontol", "anying", "shut the fuck up", "asshole", "ass"]

@bot.event
async def on_ready():
    print(f"Bot {bot.user} buatan tuan Flareable aktif dan siap nge-BAN orang toxic!")
    ...
    if any(word in msg_content for word in banned_words):
        try:
            ...
            await message.channel.send(
                f"{message.author.mention} telah diban karena menggunakan kata-kata toxic!\n"
...
bot.run("MTM3NDk2MzUyODMzNDcwODg0OQ.G8_GbC.hH54j0wqlwGIoS14YWw5zNt4ivcFkHtL4sXyqs")